 ...
 * @author Philon
 */
public abstract class BaseScreenRenderer
{
	private static SpriteBatch batch = new SpriteBatch();
	private AllData dataAccessor;
	private OrthographicCamera camera;
	private final boolean stretch;
	public static AloneSpaceFont font = new AloneSpaceFont( new BitmapFont( true ), batch );

	/**
	 * @param stretch if view should be stretched when resized
	 */
	public BaseScreenRenderer( AllData dataAccessor, boolean stretch )
	{
